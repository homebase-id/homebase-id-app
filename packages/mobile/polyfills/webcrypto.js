...
// Fork from https://github.com/PeculiarVentures/webcrypto;
// Needed to fork to:
// - allow remapping of node.js crypto to react-native-quick-crypto
// - to remove tslib
// - to remove process (which is not there in react-native)
...
function setCryptoKey(value) {
  const key = core__namespace.CryptoKey.create(
    value.algorithm,
    value.type,
    value.extractable,
    value.usages
