import { ApiType, DotYouClient, ImageSize, SystemFileType, TargetDrive } from '@youfoundation/js-lib/core';
...
import { getFileHeaderOverPeer, getFileHeaderOverPeerByGlobalTransitId } from '@youfoundation/js-lib/peer';
...
export const getDecryptedMediaDataOverPeerByGlobalTransitId = async (
    ...
    const getBytes = async () => {
        ...
        return await getPayloadBytesOverPeer(dotYouClient, odinId, targetDrive, globalTransitId, fileKey, authToken, {
            systemFileType,
            lastModified,
        });
    };
...
export const getDecryptedMediaUrlOverPeer = async (
    ...
    const getBytes = async () => {
        ...
        return await getPayloadBytesOverPeer(dotYouClient, odinId, targetDrive, fileId, fileKey, authToken, {
            systemFileType,
            lastModified,
        });
    };
