import { ApiType, deleteFile, deleteFilesByGroupId, DotYouClient, getFileHeaderByUniqueId, HomebaseFile, NewHomebaseFile, queryBatch, SecurityGroupType, TransferUploadStatus, uploadFile, uploadHeader } from '@homebase-id/js-lib/core';
import {
    getChatMessages,
...
describe('ChatProvider', () => {
    ...
    it('should get chat messages', async () => {
        ...
        expect(queryBatch).toHaveBeenCalledWith(
            ...
            { maxRecords: pageSize, cursorState, includeMetadataHeader: true, includeTransferHistory: true }
        );
    ...
    it('should soft delete a chat message', async () => {
        ...
        const updateChatMessageSpy = jest.spyOn(ChatProvider, 'updateChatMessage')
            .mockResolvedValue({
    ...
    it('should request mark as read', async () => {
        ...
        const messages = [{ fileId: 'message-id', fileMetadata: { appData: { content: { deliveryStatus: ChatDeliveryStatus.Sent } }, senderOdinId: 'sender-Odin-Id' } }] as HomebaseFile<ChatMessage>[];
